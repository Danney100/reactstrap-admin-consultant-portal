        ...
        <Col md={12} sm={12} xs={12}>
          <Card lg={12} md={12} sm={12} xs={12} className="mb-3">
            ...
            <ListGroup>
              ...
              <Row lg={12} md={12} sm={12} xs={12} form className="mx-2 pb-4 border-bottom">
                <Col
                  xl={{size: 1}}
                  className={`${classes.inpuStyle} mt-2 d-flex align-items-center`}>
                ...
                <Col xl={{size: 3}} className={`${classes.inpuStyle} mx-2 mt-2`}>
                  <Input
                    ...
                    innerRef={register}
                    name="operator">
                    <option value="wildcard">Like</option>
          ...
          <Row className="mb-3">
            <Col className="d-flex justify-content-end">
              ...
              <CommonButton title="Search" onClick={handleSearch} buttonType="saveButton" />
            </Col>
          </Row>
        </Col>
      </Row>
