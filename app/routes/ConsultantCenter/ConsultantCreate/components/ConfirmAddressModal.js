...
const ConfirmAddressModal = (props) => {
  ...
  const {billing_address} = getValues()
      ...
      <ModalBody>
        ...
        <Row className="mt-3">
          <Col md={6}>
            ...
            <Col className="px-0">
              <Col>
                <span>{billing_address.line_1}</span>
              </Col>
              <Col>
                <span>{billing_address.line_2}</span>
              </Col>
              <Col>
                <span>{`${billing_address?.city ? billing_address?.city + ',' : ''} ${
                  billing_address.county.label
                } ${billing_address.postcode}`}</span>
              </Col>
              <Col>
                <span>{billing_address.country.label}</span>
              </Col>
              <Col>
