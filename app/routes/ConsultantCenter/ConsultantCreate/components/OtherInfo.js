        ...
        <Row form>
          <Col md={{size: 4, offset: 2}}>
            <FormGroup className="mr-md-5 mx-3">
              ...
              <Input type="select" name="consultant_type" innerRef={register}>
          ...
          <Col md={{size: 4}}>
            <FormGroup className="ml-md-5 mx-3">
              ...
              <Input type="select" name="Business_type" innerRef={register}>
        ...
        <Row form>
          <Col md={{size: 4, offset: 2}}>
            <FormGroup className="mr-md-5 mx-3">
              ...
              <Input type="select" name="tax_exempt" innerRef={register}>
        ...
        <Row form>
          <Col md={{size: 4, offset: 2}}>
            <FormGroup className="mr-md-5 mx-3">
              ...
              <Input type="text" innerRef={register} name="replicated_site_url" defaultValue="" />
            </FormGroup>
          </Col>
          <Col md={{size: 4}}>
            <FormGroup className="ml-md-5 mx-3">
        ...
        <Row form>
          <Col md={{size: 4, offset: 2}}>
            <FormGroup className="mr-md-5 mx-3">
              ...
              <Input type="select" name="consultant_status" innerRef={register}>
                <option></option>
        ...
        <Row form>
          <Col md={{size: 4, offset: 2}}>
            <FormGroup className="mr-md-5 mx-3">
              ...
              <Input type="select" name="block_portal" innerRef={register}>
                <option></option>
                <option>Yes</option>
                <option>No</option>
              </Input>
          ...
          <Col md={{size: 4}}>
            <FormGroup className="ml-md-5 mx-3">
              ...
              <Input type="select" name="block_website" innerRef={register}>
                <option></option>
                <option>Yes</option>
                <option>No</option>
              </Input>
