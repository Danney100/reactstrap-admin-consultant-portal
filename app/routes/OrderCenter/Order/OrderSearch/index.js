...
import {setCustomerDetails} from 'duck/actions/order'
...
export const OrderSearch = () => {
  const customerToDisplay = useSelector(({customer}) => customer.get('customerToDisplay', null))
  ...
  const routeChange = () => {
    history.push('/order-center/order-edit')
  }
        ...
        <Col md={12} sm={12} xs={12}>
          <div className="d-flex justify-content-end mb-4">
            <CommonButton
              ...
              onClick={routeChange}></CommonButton>
          </div>
                ...
                <Col md={6} className="d-flex justify-content-start">
                  <FormGroup>
                    <p className={classes.title}>
                      Order Search: {`${customerDetails.number}`}(record 2 of 500)
                    </p>
                  </FormGroup>
                </Col>
